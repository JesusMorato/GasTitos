...
.back-link { display: inline-flex; align-items: center; gap: 0.2rem; color: var(--ink-2); text-decoration: none; font-weight: 600; font-size: 0.9rem; padding: 0.35rem 0.5rem 0.35rem 0; min-height: 40px; }
